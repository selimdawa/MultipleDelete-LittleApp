package com.littleapp.multipledelete.Adapter
...
import com.littleapp.multipledelete.Model.MultiDelete
import com.littleapp.multipledelete.R
import com.littleapp.multipledelete.databinding.ItemMultiDeleteBinding
            ...
            if (!isEnable) {
                val callback: ActionMode.Callback = object : ActionMode.Callback {
                    override fun onCreateActionMode(actionMode: ActionMode, menu: Menu): Boolean {
                        actionMode.menuInflater.inflate(R.menu.menu, menu)
                        return true
                    }
